...
?>
<?php if( $theme_options['fbk_bar'] ){?>
<div class="facebook-call">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <?php if (!empty($theme_options['facebook_url'])&&($theme_options['fbk_bar_link'])) {?>
                    <a target="_blank" href="<?php echo $theme_options['facebook_url']; ?>">
                <?php }?>
                        <?php if ($theme_options['fbk_bar_ico']) {?>
                        <div class="facebook-icon fade-in-up <?php echo inspiry_animation_class(); ?>">
                            <i class="fa fa-facebook img-circle"></i>
                        </div>
                        <?php }?>
                        <?php if (!empty($theme_options['fbk_bar_title'])) {?>
                        <p class="facebook-text fade-in-up <?php echo inspiry_animation_class(); ?>">
                           <?php echo $theme_options['fbk_bar_title'];?>
                        </p>
                        <?php }?>
                        <?php if (!empty($theme_options['facebook_url'])&&($theme_options['fbk_bar_link'])) {?>
                    </a>
