...
<section class="home-services-section clearfix">
    ...
    ?>
    <?php if ($theme_options['home_services_bg']) {
        $bg_style = $theme_options['home_services_bg'];
    }
    ?>
    <div class="section-top" <?php echo $theme_options['home_services_bg']?'style="background:url('.$theme_options['home_services_bg']['url'].') no-repeat top center"':''; ?>>
