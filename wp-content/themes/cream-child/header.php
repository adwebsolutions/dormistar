...
<div class="top-bar-wrapper nav-down">
    <div class="top-bar container fadeInDown animated">
        <div class="col-sm-6 left-side">
            ...
            if ($theme_options['left_bar_info_type']['mail'] || $theme_options['left_bar_info_type']['phone'] || $theme_options['left_bar_info_type']['address']){
                if($theme_options['left_bar_ico']){
                    if($theme_options['left_bar_info_type']['mail']) {
            ?>
                        <i class="fa fa-envelope-o"></i>
            <?php
                    }
                    else if($theme_options['left_bar_info_type']['address']){
            ?>
                        <i class="fa fa-home"></i>
            <?php
                    }
                    else if($theme_options['left_bar_info_type']['phone']){
            ?>
            ...
            <?php
                ...
                if($theme_options['left_bar_info_type']['mail']) {
            ?>
                    <a href="mailto:<?php echo $theme_options['left_bar_info_text'];?>"><?php echo $theme_options['left_bar_info_text'];?></a>
            <?php
                } else {
                    echo $theme_options['left_bar_info_text'];
                }
            }
            ?>
        </div>
        <div class="col-sm-6 right-side">
            ...
            if ($theme_options['right_bar_info_type']['mail'] || $theme_options['right_bar_info_type']['phone'] || $theme_options['right_bar_info_type']['address']){
                if($theme_options['right_bar_ico']){
                    if($theme_options['right_bar_info_type']['mail']) {
                        ?>
                        <i class="fa fa-envelope-o"></i>
                        <?php
                    }
                    else if($theme_options['right_bar_info_type']['address']){
                        ?>
                        <i class="fa fa-home"></i>
                        <?php
                    }
                    else if($theme_options['right_bar_info_type']['phone']){
                        ?>
                        <i class="fa fa-phone"></i>
                        <?php
                    }
                ...
                if($theme_options['right_bar_info_type']['mail']) {
                    ?>
                    <span class="top-bar-text"><a href="mailto:<?php echo $theme_options['right_bar_info_text'];?>"><?php echo $theme_options['right_bar_info_text'];?></a></span>
                    <?php
                } else {
                        echo "<span class='top-bar-text'>".$theme_options['right_bar_info_text']."</span>";
