                        ...
                        <td class="product-wrap">
                            ...
                            <div class="product-detail">
                                ...
                                if ( ! $_product->is_visible() )
                                    ...
                                    echo apply_filters( 'woocommerce_cart_item_name', sprintf( '<h4 class="product-name"><a href="%s">%s</a></h4>', $_product->get_permalink( $cart_item ), $_product->get_title() ), $cart_item, $cart_item_key );
